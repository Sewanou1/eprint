        ...
        <div class="row justify-content-between">
            <div class="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex align-items-center">
                <div data-aos="zoom-out">
                    ...
                    <h2>Une plateforme web qui va permettre à toute structure d’impression de faire valoir ses
                        services aux personnes qui sont dans le besoin</h2>
                    <div class="text-center text-lg-start">
                        <a href="{{ route('commande.index') }}" class="btn-get-started scrollto">Commander
                            maintenant</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 order-1 order-lg-2 hero-img" data-aos="zoom-out" data-aos-delay="300">
                <img src="assets/img/imprimer1.png" class="img-fluid animated" alt="">
            </div>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="row content">
                ...
                <div class="text-center mt-5 text">
                    <a href="{{ route('commande.index') }}" class="btn-get-started scrollto">Commander maintenant</a>
                </div>
            </div>
            ...
            <div class="text-center mt-5 text">
                <a href="{{ route('inscription') }}" class="btn-get-started scrollto">Inscrivez-vous maintenant</a>
            </div>
    ...
    <section id="features" class="features">
        <div class="container">
            ...
            <div class="text-center mt-5">
                <a href="#about" class="btn-get-started scrollto">Commander maintenant</a>
            </div>
        </div>
            ...
            <div class="swiper-slide">
                <div class="col-lg-12 ">
                    <div class="">
                        <h6 class=" ">E-PRINT
                            Témoignages</h6>
                        <h1 class="section-title ">Que disent les clients à <br>
                            propos de <span>E-PRINT</span>?</h1>
                    </div>
                </div>
            </div>
...
.contact .info-box {
  ...
  .contact .form-email .error-message {
    display: none;
    color: #fff;
    background: #ed3c0d;
    text-align: left;
  ...
  .contact .form-email .sent-message {
    display: none;
    color: #fff;
    background: #18d26e;
    text-align: center;
  ...
  .contact .form-email .loading:before {
    content: "";
    display: inline-block;
    border-radius: 50%;
    width: 24px;
  ...
  .contact .form-email input:focus, .contact .form-email textarea:focus {
    border-color: #4154f1;
  }
