<template>
    ...
    <div class="hello">
        <main class="main-content ">
            <div class="position-relative iq-banner mt-5">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="flex-wrap d-flex justify-content-between align-items-center">
                                    <div>
                                        <h1>Salut !</h1>
                                        <p>Nous vous offrons des impressions de qualité.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="d-flex flex-wrap align-items-center justify-content-between">
                                    <div class="d-flex flex-wrap align-items-center">
                                        ...
                                        <div class="d-flex flex-wrap align-items-center mb-3 mb-sm-0">
                                            <h4 class="me-2 h4">CENTRE D'IMPRESSION</h4>
                                            <span> - Impression de bâche</span>
                                        </div>
                                    </div>
                                    <ul class="d-flex nav nav-pills mb-0 text-center profile-tab"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active show" data-bs-toggle="tab" href="#profile-feed"
                                                role="tab" aria-selected="false">Commander</a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" data-bs-toggle="tab" href="#profile-profile" role="tab"
                                                aria-selected="false">Présentation</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                            ...
                                            <div class="row" data-aos="fade-left">
                                                ...
                                                <div class="col-lg-3 col-md-6 mt-5 mt-lg-0">
                                                    <MDBModal class="modal fade" id="exampleModalLong" tabindex="-1"
                                                        ...
                                                        <MDBModalFooter>
                                                            <MDBBtn color="secondary" @click="exampleModalLong = false">
                                                                Annuler </MDBBtn>
                                                            <MDBBtn color="primary"> Ajouter au panier </MDBBtn>
                                                        </MDBModalFooter>
                                                    </MDBModal>
                                                    <MDBBtn aria-controls="exampleModalScrollableTitle"
                                                    ...
                                                    <MDBModal id="exampleModalScrollable" tabindex="-1"
                                    ...
                                    <section id="team" class="team">
                                        <div class="container ">
                                            ...
                                            <div class="" style="text-align:justify ;">
                                                ...
                                                <P>Nous sommes un centre d'expertise en impression qui est à votre
                                                    disposition pour toute vos commandes en
                                                    imprimérie. Nous offrons la meilleurs qualité des services au
                                                    clients et tout ça dans des délais bien
                                                    respecté. Quelque soit le caractère de votre document, l'impression
                                                    se passe en toute securité. Notre centre prend en compte la
                                                    sécurisation de l’impression des documents à
                                                    caractère confidentiel pour certains clients. Une destruction totale
                                                    du fichier de sa base
                                                    de données après impression de ce dernier, ceci si le client
                                                    mentionne le caractère
                                                    confidentiel de son document au cours de sa commande.</P>
                                                <p>Vos commandes sont livré par notre centre en toute sécurité. Faite
                                                    nous confiance et vous ne serez pas
                                                    deçu. </p>
...
.img-thumbnail {
    ...
    border-radius: .5rem;
    -webkit-box-shadow: 0 .125rem .25rem rgba(17, 38, 146, .1);
    box-shadow: 0 .125rem .25rem rgba(17, 38, 146, .1);
    max-width: 100%;
    height: auto
}
...
.form-control:focus {
    ...
    border-color: #9dabf4;
    outline: 0;
    -webkit-box-shadow: 0 0 0 0, 0 .125rem .25rem 0rem rgba(58, 87, 232, .15);
    box-shadow: 0 0 0 0, 0 .125rem .25rem 0rem rgba(58, 87, 232, .15)
}
...
.form-select {
    ...
    -webkit-border-radius: .5rem;
    border-radius: .5rem;
    -webkit-box-shadow: inset 0 4px 8px rgba(0, 0, 0, .16);
...
.form-select:focus {
    border-color: #9dabf4;
    outline: 0;
    -webkit-box-shadow: inset 0 4px 8px rgba(0, 0, 0, .16), 0 0 0 0rem rgba(58, 87, 232, .15);
    box-shadow: inset 0 4px 8px rgba(0, 0, 0, .16), 0 0 0 0rem rgba(58, 87, 232, .15)
}
...
.form-check-input:focus {
    border-color: #9dabf4;
    outline: 0;
    -webkit-box-shadow: 0 .125rem .25rem 0rem rgba(58, 87, 232, .15);
    box-shadow: 0 .125rem .25rem 0rem rgba(58, 87, 232, .15)
}
...
.form-range:focus::-webkit-slider-thumb {
    -webkit-box-shadow: 0 0 0 1px #f5f6fa, 0 .125rem .25rem 0rem rgba(58, 87, 232, .15);
    box-shadow: 0 0 0 1px #f5f6fa, 0 .125rem .25rem 0rem rgba(58, 87, 232, .15)
}
...
.form-range::-webkit-slider-thumb {
    ...
    border-radius: 1rem;
    -webkit-box-shadow: 0 .125rem .5rem rgba(58, 87, 232, .5);
    box-shadow: 0 .125rem .5rem rgba(58, 87, 232, .5);
...
.valid-tooltip {
    ...
    font-size: 0.875rem;
    color: #fff;
    background-color: rgba(26, 160, 83, .9);
    -webkit-border-radius: .25rem;
    border-radius: .25rem
}
...
.form-control.is-valid {
    ...
    -webkit-background-size: -webkit-calc(0.75em + 0.5rem) -webkit-calc(0.75em + 0.5rem);
...
.form-control.is-valid:focus {
    border-color: #1aa053;
    -webkit-box-shadow: 0 0 .25rem 0rem rgba(26, 160, 83, .15);
    box-shadow: 0 0 .25rem 0rem rgba(26, 160, 83, .15)
}
...
.form-select.is-valid:not([multiple])[size="1"] {
    ...
    -webkit-background-size: 16px 12px, -webkit-calc(0.75em + 0.5rem) -webkit-calc(0.75em + 0.5rem);
...
.form-control.is-invalid:focus {
    border-color: #c03221;
    -webkit-box-shadow: 0 0 .25rem 0rem rgba(192, 50, 33, .15);
    box-shadow: 0 0 .25rem 0rem rgba(192, 50, 33, .15)
}
...
.btn:active:focus,
.btn.active:focus {
    -webkit-box-shadow: 0 .125rem .25rem 0rem rgba(58, 87, 232, .15), 0 0px 0px rgba(0, 0, 0, 0);
    box-shadow: 0 .125rem .25rem 0rem rgba(58, 87, 232, .15), 0 0px 0px rgba(0, 0, 0, 0)
}
...
.btn-primary:focus {
    ...
    background-color: #314ac5;
    border-color: #2e46ba;
    -webkit-box-shadow: 0 0px 0px 0 rgba(0, 0, 0, 0), 0 0 0 0rem rgba(88, 112, 235, .5);
    box-shadow: 0 0px 0px 0 rgba(0, 0, 0, 0), 0 0 0 0rem rgba(88, 112, 235, .5)
}
...
.show>.btn-primary.dropdown-toggle:focus {
    -webkit-box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(88, 112, 235, .5);
    box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(88, 112, 235, .5)
}
...
.btn-secondary:focus {
    ...
    background-color: #5c636a;
    border-color: #565e64;
    -webkit-box-shadow: 0 0px 0px 0 rgba(0, 0, 0, 0), 0 0 0 0rem rgba(130, 138, 145, .5);
    box-shadow: 0 0px 0px 0 rgba(0, 0, 0, 0), 0 0 0 0rem rgba(130, 138, 145, .5)
}
...
.show>.btn-secondary.dropdown-toggle:focus {
    -webkit-box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(130, 138, 145, .5);
    box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(130, 138, 145, .5)
}
...
.btn-success:focus {
    ...
    background-color: #168847;
    border-color: #158042;
    -webkit-box-shadow: 0 0px 0px 0 rgba(0, 0, 0, 0), 0 0 0 0rem rgba(60, 174, 109, .5);
    box-shadow: 0 0px 0px 0 rgba(0, 0, 0, 0), 0 0 0 0rem rgba(60, 174, 109, .5)
}
...
.show>.btn-success.dropdown-toggle:focus {
    -webkit-box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(60, 174, 109, .5);
    box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(60, 174, 109, .5)
}
...
.btn-info:focus {
    ...
    background-color: #06838a;
    border-color: #067b82;
    -webkit-box-shadow: 0 0px 0px 0 rgba(0, 0, 0, 0), 0 0 0 0rem rgba(44, 169, 176, .5);
    box-shadow: 0 0px 0px 0 rgba(0, 0, 0, 0), 0 0 0 0rem rgba(44, 169, 176, .5)
}
...
.show>.btn-info.dropdown-toggle:focus {
    -webkit-box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(44, 169, 176, .5);
    box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(44, 169, 176, .5)
}
...
.btn-warning:focus {
    ...
    background-color: #cd5a17;
    border-color: #c15516;
    -webkit-box-shadow: 0 0px 0px 0 rgba(0, 0, 0, 0), 0 0 0 0rem rgba(243, 128, 61, .5);
    box-shadow: 0 0px 0px 0 rgba(0, 0, 0, 0), 0 0 0 0rem rgba(243, 128, 61, .5)
}
...
.show>.btn-warning.dropdown-toggle:focus {
    -webkit-box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(243, 128, 61, .5);
    box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(243, 128, 61, .5)
}
...
.btn-danger:focus {
    ...
    background-color: #a32b1c;
    border-color: #9a281a;
    -webkit-box-shadow: 0 0px 0px 0 rgba(0, 0, 0, 0), 0 0 0 0rem rgba(201, 81, 66, .5);
    box-shadow: 0 0px 0px 0 rgba(0, 0, 0, 0), 0 0 0 0rem rgba(201, 81, 66, .5)
}
...
.show>.btn-danger.dropdown-toggle:focus {
    -webkit-box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(201, 81, 66, .5);
    box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(201, 81, 66, .5)
}
...
.btn-light:focus {
    ...
    background-color: #e3e6ea;
    border-color: #e1e5e9;
    -webkit-box-shadow: 0 0px 0px 0 rgba(0, 0, 0, 0), 0 0 0 0rem rgba(189, 192, 196, .5);
    box-shadow: 0 0px 0px 0 rgba(0, 0, 0, 0), 0 0 0 0rem rgba(189, 192, 196, .5)
}
...
.show>.btn-light.dropdown-toggle:focus {
    -webkit-box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(189, 192, 196, .5);
    box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(189, 192, 196, .5)
}
...
.btn-dark:focus {
    ...
    background-color: #1c1f23;
    border-color: #1a1e21;
    -webkit-box-shadow: 0 0px 0px 0 rgba(0, 0, 0, 0), 0 0 0 0rem rgba(66, 70, 73, .5);
    box-shadow: 0 0px 0px 0 rgba(0, 0, 0, 0), 0 0 0 0rem rgba(66, 70, 73, .5)
}
...
.show>.btn-dark.dropdown-toggle:focus {
    -webkit-box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(66, 70, 73, .5);
    box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(66, 70, 73, .5)
}
...
.btn-outline-primary:focus {
    -webkit-box-shadow: 0 0 0 0rem rgba(58, 87, 232, .5);
    box-shadow: 0 0 0 0rem rgba(58, 87, 232, .5)
}
...
.btn-outline-primary.dropdown-toggle.show:focus {
    -webkit-box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(58, 87, 232, .5);
    box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(58, 87, 232, .5)
}
...
.btn-outline-secondary:focus {
    -webkit-box-shadow: 0 0 0 0rem rgba(108, 117, 125, .5);
...
.btn-outline-secondary.dropdown-toggle.show:focus {
    -webkit-box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(108, 117, 125, .5);
    box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(108, 117, 125, .5)
}
...
.btn-outline-success:focus {
    -webkit-box-shadow: 0 0 0 0rem rgba(26, 160, 83, .5);
    box-shadow: 0 0 0 0rem rgba(26, 160, 83, .5)
}
...
.btn-outline-success.dropdown-toggle.show:focus {
    -webkit-box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(26, 160, 83, .5);
    box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(26, 160, 83, .5)
}
...
.btn-outline-info:focus {
    -webkit-box-shadow: 0 0 0 0rem rgba(7, 154, 162, .5);
    box-shadow: 0 0 0 0rem rgba(7, 154, 162, .5)
}
...
.btn-outline-info.dropdown-toggle.show:focus {
    -webkit-box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(7, 154, 162, .5);
    box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(7, 154, 162, .5)
}
...
.btn-outline-warning:focus {
    -webkit-box-shadow: 0 0 0 0rem rgba(241, 106, 27, .5);
    box-shadow: 0 0 0 0rem rgba(241, 106, 27, .5)
}
...
.btn-outline-warning.dropdown-toggle.show:focus {
    -webkit-box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(241, 106, 27, .5);
    box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(241, 106, 27, .5)
}
...
.btn-outline-danger:focus {
    -webkit-box-shadow: 0 0 0 0rem rgba(192, 50, 33, .5);
    box-shadow: 0 0 0 0rem rgba(192, 50, 33, .5)
}
...
.btn-outline-danger.dropdown-toggle.show:focus {
    -webkit-box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(192, 50, 33, .5);
    box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(192, 50, 33, .5)
}
...
.btn-outline-light:focus {
    -webkit-box-shadow: 0 0 0 0rem rgba(222, 226, 230, .5);
    box-shadow: 0 0 0 0rem rgba(222, 226, 230, .5)
}
...
.btn-outline-light.dropdown-toggle.show:focus {
    -webkit-box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(222, 226, 230, .5);
    box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(222, 226, 230, .5)
}
...
.btn-outline-dark:focus {
    -webkit-box-shadow: 0 0 0 0rem rgba(33, 37, 41, .5);
    box-shadow: 0 0 0 0rem rgba(33, 37, 41, .5)
}
...
.btn-outline-dark.dropdown-toggle.show:focus {
    -webkit-box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(33, 37, 41, .5);
    box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(33, 37, 41, .5)
}
...
.toast {
    ...
    -webkit-box-shadow: 0 .5rem 1rem rgba(17, 38, 146, .05);
    box-shadow: 0 .5rem 1rem rgba(17, 38, 146, .05);
    -webkit-border-radius: .25rem;
    border-radius: .25rem
}
...
.shadow {
    -webkit-box-shadow: 0 .5rem 1rem rgba(17, 38, 146, .05) !important;
    box-shadow: 0 .5rem 1rem rgba(17, 38, 146, .05) !important
}

.shadow-sm {
    -webkit-box-shadow: 0 .125rem .25rem rgba(17, 38, 146, .1) !important;
    box-shadow: 0 .125rem .25rem rgba(17, 38, 146, .1) !important
}

.shadow-lg {
    -webkit-box-shadow: 0 10px 30px 0 rgba(17, 38, 146, .05) !important;
    box-shadow: 0 10px 30px 0 rgba(17, 38, 146, .05) !important
}
...
.btn-outline-primary:hover {
    -webkit-box-shadow: 0 .125rem .25rem rgba(58, 87, 232, .3);
    box-shadow: 0 .125rem .25rem rgba(58, 87, 232, .3)
}
...
.btn-outline-secondary:hover {
    -webkit-box-shadow: 0 .125rem .25rem rgba(108, 117, 125, .3);
    box-shadow: 0 .125rem .25rem rgba(108, 117, 125, .3)
}
...
.btn-outline-success:hover {
    -webkit-box-shadow: 0 .125rem .25rem rgba(26, 160, 83, .3);
    box-shadow: 0 .125rem .25rem rgba(26, 160, 83, .3)
}
...
.btn-outline-info:hover {
    -webkit-box-shadow: 0 .125rem .25rem rgba(7, 154, 162, .3);
    box-shadow: 0 .125rem .25rem rgba(7, 154, 162, .3)
}
...
.btn-outline-warning:hover {
    -webkit-box-shadow: 0 .125rem .25rem rgba(241, 106, 27, .3);
    box-shadow: 0 .125rem .25rem rgba(241, 106, 27, .3)
}
...
.btn-outline-danger:hover {
    -webkit-box-shadow: 0 .125rem .25rem rgba(192, 50, 33, .3);
    box-shadow: 0 .125rem .25rem rgba(192, 50, 33, .3)
}
...
.btn-outline-light:hover {
    -webkit-box-shadow: 0 .125rem .25rem rgba(222, 226, 230, .3);
    box-shadow: 0 .125rem .25rem rgba(222, 226, 230, .3)
}
...
.btn-outline-dark:hover {
    -webkit-box-shadow: 0 .125rem .25rem rgba(33, 37, 41, .3);
    box-shadow: 0 .125rem .25rem rgba(33, 37, 41, .3)
}
...
.btn-soft-primary {
    color: #17235d;
    background-color: rgba(58, 87, 232, .2);
...
.btn-soft-primary:hover {
    color: #2c41ae;
    background-color: rgba(58, 87, 232, .4);
    border-color: rgba(58, 87, 232, 0)
}
...
.btn-soft-primary:focus {
    ...
    background-color: rgba(58, 87, 232, .4);
    border-color: rgba(58, 87, 232, 0);
    -webkit-box-shadow: 0 0px 0px 0 rgba(0, 0, 0, 0), 0 0 0 0rem rgba(23, 35, 93, .5);
    box-shadow: 0 0px 0px 0 rgba(0, 0, 0, 0), 0 0 0 0rem rgba(23, 35, 93, .5)
}
...
.show>.btn-soft-primary.dropdown-toggle {
    color: #344ed1;
    background-color: rgba(58, 87, 232, .6);
    border-color: rgba(58, 87, 232, 0)
}
...
.show>.btn-soft-primary.dropdown-toggle:focus {
    -webkit-box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(23, 35, 93, .5);
    box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(23, 35, 93, .5)
}
...
.btn-soft-secondary:focus {
    ...
    background-color: rgba(108, 117, 125, .4);
    border-color: rgba(108, 117, 125, 0);
    -webkit-box-shadow: 0 0px 0px 0 rgba(0, 0, 0, 0), 0 0 0 0rem rgba(43, 47, 50, .5);
    box-shadow: 0 0px 0px 0 rgba(0, 0, 0, 0), 0 0 0 0rem rgba(43, 47, 50, .5)
}
...
.show>.btn-soft-secondary.dropdown-toggle:focus {
    -webkit-box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(43, 47, 50, .5);
    box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(43, 47, 50, .5)
}
...
.btn-soft-success {
    color: #0a4021;
    background-color: rgba(26, 160, 83, .2);
...
.btn-soft-success:hover {
    color: #14783e;
    background-color: rgba(26, 160, 83, .4);
    border-color: rgba(26, 160, 83, 0)
}
...
.btn-soft-success:focus {
    ...
    background-color: rgba(26, 160, 83, .4);
    border-color: rgba(26, 160, 83, 0);
    -webkit-box-shadow: 0 0px 0px 0 rgba(0, 0, 0, 0), 0 0 0 0rem rgba(10, 64, 33, .5);
    box-shadow: 0 0px 0px 0 rgba(0, 0, 0, 0), 0 0 0 0rem rgba(10, 64, 33, .5)
}
...
.show>.btn-soft-success.dropdown-toggle {
    color: #17904b;
    background-color: rgba(26, 160, 83, .6);
    border-color: rgba(26, 160, 83, 0)
}
...
.show>.btn-soft-success.dropdown-toggle:focus {
    -webkit-box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(10, 64, 33, .5);
    box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(10, 64, 33, .5)
}
...
.btn-soft-info {
    color: #033e41;
    background-color: rgba(7, 154, 162, .2);
...
.btn-soft-info:hover {
    color: #05747a;
    background-color: rgba(7, 154, 162, .4);
    border-color: rgba(7, 154, 162, 0)
}
...
.btn-soft-info:focus {
    ...
    background-color: rgba(7, 154, 162, .4);
    border-color: rgba(7, 154, 162, 0);
    -webkit-box-shadow: 0 0px 0px 0 rgba(0, 0, 0, 0), 0 0 0 0rem rgba(3, 62, 65, .5);
    box-shadow: 0 0px 0px 0 rgba(0, 0, 0, 0), 0 0 0 0rem rgba(3, 62, 65, .5)
}
...
.show>.btn-soft-info.dropdown-toggle {
    color: #068b92;
    background-color: rgba(7, 154, 162, .6);
    border-color: rgba(7, 154, 162, 0)
}
...
.show>.btn-soft-info.dropdown-toggle:focus {
    -webkit-box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(3, 62, 65, .5);
    box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(3, 62, 65, .5)
}
...
.btn-soft-warning:hover {
    color: #b55014;
    background-color: rgba(241, 106, 27, .4);
    border-color: rgba(241, 106, 27, 0)
}
...
.btn-soft-warning:focus {
    ...
    background-color: rgba(241, 106, 27, .4);
    border-color: rgba(241, 106, 27, 0);
    -webkit-box-shadow: 0 0px 0px 0 rgba(0, 0, 0, 0), 0 0 0 0rem rgba(96, 42, 11, .5);
    box-shadow: 0 0px 0px 0 rgba(0, 0, 0, 0), 0 0 0 0rem rgba(96, 42, 11, .5)
}
...
.show>.btn-soft-warning.dropdown-toggle {
    color: #d95f18;
    background-color: rgba(241, 106, 27, .6);
    border-color: rgba(241, 106, 27, 0)
}
...
.show>.btn-soft-warning.dropdown-toggle:focus {
    -webkit-box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(96, 42, 11, .5);
    box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(96, 42, 11, .5)
}
...
.btn-soft-danger:hover {
    color: #902619;
    background-color: rgba(192, 50, 33, .4);
    border-color: rgba(192, 50, 33, 0)
}
...
.btn-soft-danger:focus {
    ...
    background-color: rgba(192, 50, 33, .4);
    border-color: rgba(192, 50, 33, 0);
    -webkit-box-shadow: 0 0px 0px 0 rgba(0, 0, 0, 0), 0 0 0 0rem rgba(77, 20, 13, .5);
    box-shadow: 0 0px 0px 0 rgba(0, 0, 0, 0), 0 0 0 0rem rgba(77, 20, 13, .5)
}
...
.show>.btn-soft-danger.dropdown-toggle {
    color: #ad2d1e;
    background-color: rgba(192, 50, 33, .6);
    border-color: rgba(192, 50, 33, 0)
}
...
.show>.btn-soft-danger.dropdown-toggle:focus {
    -webkit-box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(77, 20, 13, .5);
    box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(77, 20, 13, .5)
}
...
.btn-soft-light:focus {
    ...
    background-color: rgba(222, 226, 230, .4);
    border-color: rgba(222, 226, 230, 0);
    -webkit-box-shadow: 0 0px 0px 0 rgba(0, 0, 0, 0), 0 0 0 0rem rgba(89, 90, 92, .5);
    box-shadow: 0 0px 0px 0 rgba(0, 0, 0, 0), 0 0 0 0rem rgba(89, 90, 92, .5)
}
...
.show>.btn-soft-light.dropdown-toggle:focus {
    -webkit-box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(89, 90, 92, .5);
    box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(89, 90, 92, .5)
}
...
.btn-soft-dark:focus {
    ...
    background-color: rgba(33, 37, 41, .4);
    border-color: rgba(33, 37, 41, 0);
    -webkit-box-shadow: 0 0px 0px 0 rgba(0, 0, 0, 0), 0 0 0 0rem rgba(13, 15, 16, .5);
    box-shadow: 0 0px 0px 0 rgba(0, 0, 0, 0), 0 0 0 0rem rgba(13, 15, 16, .5)
}
...
.show>.btn-soft-dark.dropdown-toggle:focus {
    -webkit-box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(13, 15, 16, .5);
    box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(13, 15, 16, .5)
}
...
.btn-check:focus+.btn.btn-border,
...
.btn.btn-border.active,
.btn.btn-border.dropdown-toggle.show {
    color: #fff;
    background-color: #6c757d;
    border-color: #6c757d
}

.btn-check:checked+.btn.btn-border:focus,
.btn-check:active+.btn.btn-border:focus,
.btn.btn-border:active:focus,
.btn.btn-border.active:focus,
.btn.btn-border.dropdown-toggle.show:focus {
    -webkit-box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(108, 117, 125, .5);
    box-shadow: 0 0px 0px rgba(0, 0, 0, 0), 0 0 0 0rem rgba(108, 117, 125, .5)
}
...
.form-group-alt .form-control.is-valid {
    -webkit-box-shadow: 0 .125rem .25rem rgba(26, 160, 83, .1);
    box-shadow: 0 .125rem .25rem rgba(26, 160, 83, .1)
}
...
.form-group-alt .form-control.is-invalid {
    -webkit-box-shadow: 0 .125rem .25rem rgba(192, 50, 33, .1);
    box-shadow: 0 .125rem .25rem rgba(192, 50, 33, .1)
}
...
.tooltip-inner {
    -webkit-box-shadow: 0 8px 16px rgba(0, 0, 0, .1), 0 2px 4px rgba(0, 0, 0, .1);
    box-shadow: 0 8px 16px rgba(0, 0, 0, .1), 0 2px 4px rgba(0, 0, 0, .1)
}
...
.nav .navbar-inner {
    padding: 0 -webkit-calc(var(--bs-gutter-x, 0.75rem)*2);
...
.iq-navbar.nav-glass {
    background: -webkit-linear-gradient(330deg, rgba(255, 255, 255, 0.5) -8%, rgba(255, 255, 255, 0.01) 120%);
    background: -o-linear-gradient(330deg, rgba(255, 255, 255, 0.5) -8%, rgba(255, 255, 255, 0.01) 120%);
...
.sidebar+.main-content .iq-navbar-header .iq-container .h1,
.sidebar+.main-content .iq-navbar-header .iq-container h2,
.sidebar+.main-content .iq-navbar-header .iq-container .h2,
.sidebar+.main-content .iq-navbar-header .iq-container h3,
.sidebar+.main-content .iq-navbar-header .iq-container .h3,
.sidebar+.main-content .iq-navbar-header .iq-container h4,
.sidebar+.main-content .iq-navbar-header .iq-container .h4,
.sidebar+.main-content .iq-navbar-header .iq-container h5,
.sidebar+.main-content .iq-navbar-header .iq-container .h5,
.sidebar+.main-content .iq-navbar-header .iq-container h6,
.sidebar+.main-content .iq-navbar-header .iq-container .h6,
.sidebar+.main-content .iq-navbar-header .iq-container a,
.sidebar+.main-content .iq-navbar-header .iq-container p {
    color: inherit
}
...
.iq-banner .iq-navbar-header .iq-container {
    padding: -webkit-calc(var(--bs-gutter-x, 1rem)*2);
    padding: calc(var(--bs-gutter-x, 1rem)*2)
}

.iq-banner .iq-navbar-header .iq-container h1,
.iq-banner .iq-navbar-header .iq-container .h1,
.iq-banner .iq-navbar-header .iq-container h2,
.iq-banner .iq-navbar-header .iq-container .h2,
.iq-banner .iq-navbar-header .iq-container h3,
.iq-banner .iq-navbar-header .iq-container .h3,
.iq-banner .iq-navbar-header .iq-container h4,
.iq-banner .iq-navbar-header .iq-container .h4,
.iq-banner .iq-navbar-header .iq-container h5,
.iq-banner .iq-navbar-header .iq-container .h5,
.iq-banner .iq-navbar-header .iq-container h6,
.iq-banner .iq-navbar-header .iq-container .h6,
.iq-banner .iq-navbar-header .iq-container a,
.iq-banner .iq-navbar-header .iq-container p {
    color: inherit
}
...
@media(min-width: 1200px) {
    ...
    .iq-banner.default .iq-navbar.navs-transparent .product-offcanvas .breadcrumb-title,
    .iq-banner.default .iq-navbar.nav-glass .product-offcanvas .breadcrumb-title,
    .iq-banner.navs-bg-color .iq-navbar.navs-transparent .product-offcanvas .breadcrumb-title,
    .iq-banner.navs-bg-color .iq-navbar.nav-glass .product-offcanvas .breadcrumb-title {
        color: #fff
    }

    .iq-banner.default .iq-navbar.navs-transparent .product-offcanvas .breadcrumb-title h6,
    .iq-banner.default .iq-navbar.navs-transparent .product-offcanvas .breadcrumb-title .h6,
    .iq-banner.default .iq-navbar.nav-glass .product-offcanvas .breadcrumb-title h6,
    .iq-banner.default .iq-navbar.nav-glass .product-offcanvas .breadcrumb-title .h6,
    .iq-banner.navs-bg-color .iq-navbar.navs-transparent .product-offcanvas .breadcrumb-title h6,
    .iq-banner.navs-bg-color .iq-navbar.navs-transparent .product-offcanvas .breadcrumb-title .h6,
    .iq-banner.navs-bg-color .iq-navbar.nav-glass .product-offcanvas .breadcrumb-title h6,
    .iq-banner.navs-bg-color .iq-navbar.nav-glass .product-offcanvas .breadcrumb-title .h6 {
        color: #fff
    }

    .iq-banner.default .iq-navbar.navs-transparent .product-offcanvas .iq-nav-menu>.nav-item>.menu-arrow,
    .iq-banner.default .iq-navbar.nav-glass .product-offcanvas .iq-nav-menu>.nav-item>.menu-arrow,
    .iq-banner.navs-bg-color .iq-navbar.navs-transparent .product-offcanvas .iq-nav-menu>.nav-item>.menu-arrow,
    .iq-banner.navs-bg-color .iq-navbar.nav-glass .product-offcanvas .iq-nav-menu>.nav-item>.menu-arrow {
        color: #fff
    }

    .iq-banner.default .iq-navbar.navs-transparent .product-offcanvas .iq-nav-menu>.nav-item.active>.menu-arrow,
    .iq-banner.default .iq-navbar.nav-glass .product-offcanvas .iq-nav-menu>.nav-item.active>.menu-arrow,
    .iq-banner.navs-bg-color .iq-navbar.navs-transparent .product-offcanvas .iq-nav-menu>.nav-item.active>.menu-arrow,
    .iq-banner.navs-bg-color .iq-navbar.nav-glass .product-offcanvas .iq-nav-menu>.nav-item.active>.menu-arrow {
        color: var(--bs-primary)
    }
}
...
@media(max-width: 1199.98px) {
    ...
    .sidebar-default.sidebar-boxed+.main-content .content-inner {
        padding: -webkit-calc(var(--bs-gutter-x, 0.75rem)*1.25);
...
.sidebar {
    ...
    transition: all 400ms ease;
    background-color: #fff;
    -webkit-box-shadow: 0 0px 30px 0 rgba(17, 38, 146, .05);
    box-shadow: 0 0px 30px 0 rgba(17, 38, 146, .05)
}
...
.sidebar.sidebar-dark .navbar-brand svg,
...
.sidebar-default .navbar-nav .nav-item .nav-link:not(.disabled)[aria-expanded=true] {
    background-color: #3a57e8;
    color: #fff;
    -webkit-box-shadow: 0 10px 20px -10px rgba(17, 38, 146, .4);
    box-shadow: 0 10px 20px -10px rgba(17, 38, 146, .4)
}

.sidebar-default .navbar-nav .nav-item .nav-link:not(.disabled).active .right-icon,
.sidebar-default .navbar-nav .nav-item .nav-link:not(.disabled)[aria-expanded=true] .right-icon {
    -webkit-transition: all 100ms ease-in-out;
    -o-transition: all 100ms ease-in-out;
    transition: all 100ms ease-in-out;
    -webkit-transform: rotate(90deg);
...
.sidebar .sidebar-toggle:hover {
    -webkit-box-shadow: 0 .125rem .25rem rgba(58, 87, 232, .15);
    box-shadow: 0 .125rem .25rem rgba(58, 87, 232, .15)
}
...
.sidebar-mini.navs-rounded-all .navbar-nav .nav-item:not(.static-item),
.sidebar-mini.navs-pill-all .navbar-nav .nav-item:not(.static-item) {
    padding: 0
}

.sidebar-mini.navs-rounded .sidebar-list .navbar-nav .nav-item .nav-link:not(.disabled) i.sidenav-mini-icon,
.sidebar-mini.navs-pill .sidebar-list .navbar-nav .nav-item .nav-link:not(.disabled) i.sidenav-mini-icon {
    margin-left: 5px
}

.sidebar-mini.navs-rounded .sidebar-list .navbar-nav .nav-item .nav-link:not(.disabled) .sub-nav .nav-link,
.sidebar-mini.navs-pill .sidebar-list .navbar-nav .nav-item .nav-link:not(.disabled) .sub-nav .nav-link {
    padding-left: 1.5rem
}
...
.sidebar.sidebar-mini.sidebar-boxed+.main-content {
    margin-left: -webkit-calc(4.8rem + 2rem);
...
.sidebar.sidebar-boxed+.main-content {
    ...
    -o-transition: all 400ms ease;
    transition: all 400ms ease;
    margin-left: -webkit-calc(16.2rem + 2rem);
...
.sidebar-dark .navbar-nav .nav-item .nav-link:not(.disabled).active,
.sidebar-dark .navbar-nav .nav-item .nav-link:not(.disabled)[aria-expanded=true] {
    background-color: #3a57e8;
    color: #fff;
    -webkit-box-shadow: 0 10px 20px -10px rgba(17, 38, 146, .4);
    box-shadow: 0 10px 20px -10px rgba(17, 38, 146, .4)
...
@media(max-width: 1199.98px) {
    ...
    .horizontal-nav.mobile-offcanvas .container,
    .horizontal-nav.mobile-offcanvas .container-fluid,
    .horizontal-nav.mobile-offcanvas .container-sm,
    .horizontal-nav.mobile-offcanvas .container-md,
    .horizontal-nav.mobile-offcanvas .container-lg,
    .horizontal-nav.mobile-offcanvas .container-xl,
...
.footer .footer-body {
    ...
    -ms-flex-pack: justify;
    justify-content: space-between;
    padding: .5rem -webkit-calc(var(--bs-gutter-x, 0.75rem)*3);
...
.slider.noUi-horizontal .noUi-handle {
    border-color: #3a57e8;
    -webkit-box-shadow: 0 .125rem .25rem #3a57e8;
    box-shadow: 0 .125rem .25rem #3a57e8
}

.slider.noUi-horizontal .noUi-handle:hover {
    -webkit-box-shadow: 0 .125rem .25rem #3a57e8, 0 .125rem .5rem #3a57e8;
    box-shadow: 0 .125rem .25rem #3a57e8, 0 .125rem .5rem #3a57e8
}
...
.slider-secondary.noUi-horizontal .noUi-handle {
    border-color: #6c757d;
    -webkit-box-shadow: 0 .125rem .25rem #6c757d;
    box-shadow: 0 .125rem .25rem #6c757d
}

.slider-secondary.noUi-horizontal .noUi-handle:hover {
    -webkit-box-shadow: 0 .125rem .25rem #6c757d, 0 .125rem .5rem #6c757d;
    box-shadow: 0 .125rem .25rem #6c757d, 0 .125rem .5rem #6c757d
}
...
.slider-success.noUi-horizontal .noUi-handle {
    border-color: #1aa053;
    -webkit-box-shadow: 0 .125rem .25rem #1aa053;
    box-shadow: 0 .125rem .25rem #1aa053
}

.slider-success.noUi-horizontal .noUi-handle:hover {
    -webkit-box-shadow: 0 .125rem .25rem #1aa053, 0 .125rem .5rem #1aa053;
    box-shadow: 0 .125rem .25rem #1aa053, 0 .125rem .5rem #1aa053
}
...
.slider-danger.noUi-horizontal .noUi-handle {
    border-color: #c03221;
    -webkit-box-shadow: 0 .125rem .25rem #c03221;
    box-shadow: 0 .125rem .25rem #c03221
}

.slider-danger.noUi-horizontal .noUi-handle:hover {
    -webkit-box-shadow: 0 .125rem .25rem #c03221, 0 .125rem .5rem #c03221;
    box-shadow: 0 .125rem .25rem #c03221, 0 .125rem .5rem #c03221
}
...
.slider-warning.noUi-horizontal .noUi-handle {
    border-color: #f16a1b;
    -webkit-box-shadow: 0 .125rem .25rem #f16a1b;
    box-shadow: 0 .125rem .25rem #f16a1b
}

.slider-warning.noUi-horizontal .noUi-handle:hover {
    -webkit-box-shadow: 0 .125rem .25rem #f16a1b, 0 .125rem .5rem #f16a1b;
    box-shadow: 0 .125rem .25rem #f16a1b, 0 .125rem .5rem #f16a1b
}
...
.slider-info.noUi-horizontal .noUi-handle {
    border-color: #079aa2;
    -webkit-box-shadow: 0 .125rem .25rem #079aa2;
    box-shadow: 0 .125rem .25rem #079aa2
}

.slider-info.noUi-horizontal .noUi-handle:hover {
    -webkit-box-shadow: 0 .125rem .25rem #079aa2, 0 .125rem .5rem #079aa2;
    box-shadow: 0 .125rem .25rem #079aa2, 0 .125rem .5rem #079aa2
}
...
.slider-dark.noUi-horizontal .noUi-handle {
    border-color: #212529;
    -webkit-box-shadow: 0 .125rem .25rem #212529;
    box-shadow: 0 .125rem .25rem #212529
}

.slider-dark.noUi-horizontal .noUi-handle:hover {
    -webkit-box-shadow: 0 .125rem .25rem #212529, 0 .125rem .5rem #212529;
    box-shadow: 0 .125rem .25rem #212529, 0 .125rem .5rem #212529
}
...
.slider-light.noUi-horizontal .noUi-handle {
    border-color: #dee2e6;
    -webkit-box-shadow: 0 .125rem .25rem #dee2e6;
    box-shadow: 0 .125rem .25rem #dee2e6
}

.slider-light.noUi-horizontal .noUi-handle:hover {
    -webkit-box-shadow: 0 .125rem .25rem #dee2e6, 0 .125rem .5rem #dee2e6;
    box-shadow: 0 .125rem .25rem #dee2e6, 0 .125rem .5rem #dee2e6
}

.custom-form-floating>.form-control::-webkit-input-placeholder {
    color: transparent
}
...
.custom-form-floating>.form-control::-ms-input-placeholder {
    color: transparent
}
...
.custom-form-floating>label {
    height: unset;
    -webkit-transform: scale(1.125) translateY(0.5rem) translateX(0.5rem);
    -ms-transform: scale(1.125) translateY(0.5rem) translateX(0.5rem);
...
.custom-form-floating>.form-control:not(:placeholder-shown)~label,
.custom-form-floating>.form-select~label {
    -webkit-transform: scale(0.85) translateY(-1rem) translateX(0.75rem);
    -ms-transform: scale(0.85) translateY(-1rem) translateX(0.75rem);
...
.custom-form-floating-sm>.form-select {
    height: -webkit-calc(2.7rem + 2px);
    height: calc(2.7rem + 2px)
}

.custom-form-floating-sm>label {
    height: unset;
    -webkit-transform: scale(1.125) translateY(0.25rem) translateX(0.5rem);
    -ms-transform: scale(1.125) translateY(0.25rem) translateX(0.5rem);
...
.custom-form-floating-lg>.form-select {
    height: -webkit-calc(4.2rem + 2px);
    height: calc(4.2rem + 2px)
}

.custom-form-floating-lg>label {
    height: unset;
    -webkit-transform: scale(1.125) translateY(1rem) translateX(0.5rem);
    -ms-transform: scale(1.125) translateY(1rem) translateX(0.5rem);
...
.custom-form-floating-flat .form-control.is-valid,
.custom-form-floating-flat .form-control.is-invalid {
    -webkit-box-shadow: none;
    box-shadow: none
}
...
.iq-timeline ul li:nth-child(odd) .time {
    ...
    -ms-box-shadow: 0px 0px 0px 3px rgba(80, 181, 255, .3);
    -o-box-shadow: 0px 0px 0px 3px rgba(80, 181, 255, .3);
...
.iq-timeline ul li:nth-child(even) .time {
    ...
    -ms-box-shadow: 0px 0px 0px 3px rgba(73, 240, 211, .3);
    -o-box-shadow: 0px 0px 0px 3px rgba(73, 240, 211, .3);
...
.credit-card-widget .primary-gradient-card {
    background: -webkit-linear-gradient(332.24deg, rgba(255, 255, 255, 0.5) -7.21%, rgba(255, 255, 255, 0.01) 118.08%);
    background: -o-linear-gradient(332.24deg, rgba(255, 255, 255, 0.5) -7.21%, rgba(255, 255, 255, 0.01) 118.08%);
...
.credit-card-widget .primary-gradient-card h5,
.credit-card-widget .primary-gradient-card .h5,
.credit-card-widget .primary-gradient-card h6,
.credit-card-widget .primary-gradient-card .h6 {
    color: #fff
}
...
.credit-card-widget .card-header::before {
    ...
    top: -45px;
    left: -3.125rem;
    -webkit-box-shadow: 0px 10px 50px 10px rgba(153, 159, 172, .2);
    box-shadow: 0px 10px 50px 10px rgba(153, 159, 172, .2)
}
...
.credit-card-widget .card-header::after {
    ...
    bottom: -45px;
    right: -3.125rem;
    -webkit-box-shadow: -10px 0px 50px 10px rgba(75, 199, 210, .2);
    box-shadow: -10px 0px 50px 10px rgba(75, 199, 210, .2)
}
...
.icon-pill a {
    -webkit-box-shadow: 0 4px 8px 0px rgba(76, 128, 178, .2);
    box-shadow: 0 4px 8px 0px rgba(76, 128, 178, .2)
}
...
.gradient {
    height: 100vh;
    background: -webkit-radial-gradient(50% 50%, 20% 60%, #3B8AFF 0%, #0048b3 100%);
    background: -o-radial-gradient(50% 50%, 20% 60%, #3B8AFF 0%, #0048b3 100%);
...
.gradient .box .c {
    ...
    border-radius: 50%;
    padding: 9rem;
    background: -webkit-radial-gradient(50% 50%, 60% 60%, transparent 67%, #00000078 100%);
    background: -o-radial-gradient(50% 50%, 60% 60%, transparent 67%, #00000078 100%);
...
.gradient-bottom-left .xl-circle {
    -webkit-transform: translate(-21px, 250px);
    -ms-transform: translate(-21px, 250px);
    transform: translate(-21px, 250px)
}

.gradient-bottom-left .lg-circle {
    -webkit-transform: translate(-139px, 60px);
    -ms-transform: translate(-139px, 60px);
...
.gradient-bottom-left .sm-circle {
    ...
    -ms-transform: translate(-56px, -19px);
    transform: translate(-56px, -19px)
}

.gradient-bottom-left .xs-circle {
    -webkit-transform: translate(-4px, -56px);
    -ms-transform: translate(-4px, -56px);
...
.gradient-bottom-left-two .xl-circle {
    -webkit-transform: translate(-186px, 195px);
    -ms-transform: translate(-186px, 195px);
...
.gradient-bottom-left-two .sm-circle {
    -webkit-transform: translate(-42px, -62px);
    -ms-transform: translate(-42px, -62px);
    transform: translate(-42px, -62px)
}

.gradient-bottom-left-two .xs-circle {
    -webkit-transform: translate(-24px, -68px);
    -ms-transform: translate(-24px, -68px);
...
.gradient-top-right-two .xl-circle {
    -webkit-transform: translate(245px, -104px);
    -ms-transform: translate(245px, -104px);
...
.gradient-top-right-two .md-circle {
    ...
    -ms-transform: translate(11px, 79px);
    transform: translate(11px, 79px)
}

.gradient-top-right-two .sm-circle {
    -webkit-transform: translate(122px, -61px);
    -ms-transform: translate(122px, -61px);
    transform: translate(122px, -61px)
}

.gradient-top-right-two .xs-circle {
    -webkit-transform: translate(-22px, 73px);
    -ms-transform: translate(-22px, 73px);
...
.gradient-bottom-right .xl-circle {
    -webkit-transform: translate(85px, 183px);
    -ms-transform: translate(85px, 183px);
    transform: translate(85px, 183px)
}

.gradient-bottom-right .lg-circle {
    -webkit-transform: translate(56px, 41px);
    -ms-transform: translate(56px, 41px);
...
.gradient-bottom-right .sm-circle {
    -webkit-transform: translate(63px, -52px);
    -ms-transform: translate(63px, -52px);
    transform: translate(63px, -52px)
}

.gradient-bottom-right .xs-circle {
    -webkit-transform: translate(62px, -51px);
    -ms-transform: translate(62px, -51px);
...
.gradient-top .xl-circle {
    -webkit-transform: translate(-68px, 305px);
    -ms-transform: translate(-68px, 305px);
    transform: translate(-68px, 305px)
}

.gradient-top .lg-circle {
    -webkit-transform: translate(-127px, 134px);
    -ms-transform: translate(-127px, 134px);
...
.gradient-top .sm-circle {
    -webkit-transform: translate(-36px, -52px);
    -ms-transform: translate(-36px, -52px);
    transform: translate(-36px, -52px)
}

.gradient-top .xs-circle {
    -webkit-transform: translate(-72px, -51px);
    -ms-transform: translate(-72px, -51px);
...
.gradient-bottom .xl-circle {
    -webkit-transform: translate(223px, -342px);
    -ms-transform: translate(223px, -342px);
    transform: translate(223px, -342px)
}

.gradient-bottom .lg-circle {
    -webkit-transform: translate(84px, 26px);
    -ms-transform: translate(84px, 26px);
    transform: translate(84px, 26px)
}

.gradient-bottom .md-circle {
    -webkit-transform: translate(114px, 16px);
...
button.bg-soft-primary:focus {
    color: #1632bf;
    background-color: rgba(58, 87, 232, .3) !important
}
...
.bg-soft-success {
    color: #17904b;
    background-color: rgba(26, 160, 83, .2) !important
}
...
button.bg-soft-success:focus {
    color: #0f5e31;
    background-color: rgba(26, 160, 83, .3) !important
}

.bg-soft-info {
    color: #068b92;
    background-color: rgba(7, 154, 162, .2) !important
}
...
button.bg-soft-info:focus {
    color: #045459;
    background-color: rgba(7, 154, 162, .3) !important
}
...
button.bg-soft-warning:focus {
    color: #b44a0b;
    background-color: rgba(241, 106, 27, .3) !important
}
...
button.bg-soft-danger:focus {
    color: #7f2116;
    background-color: rgba(192, 50, 33, .3) !important
}
...
.hr-vertial {
    width: 1px;
    height: auto !important;
    margin: 0 -webkit-calc(1rem/2);
    margin: 0 calc(1rem/2);
    background: transparent;
    background-image: -webkit-gradient(linear, left top, left bottom, from(transparent), color-stop(rgba(0, 0, 0, 0.4)), to(transparent));
    background-image: -webkit-linear-gradient(top, transparent, rgba(0, 0, 0, 0.4), transparent);
    background-image: -o-linear-gradient(top, transparent, rgba(0, 0, 0, 0.4), transparent);
...
.datepicker-controls .button {
    ...
    background-color: #fff;
    cursor: pointer;
    padding: -webkit-calc(0.375em - 1px) .75em;
...
.datepicker-input.in-edit:active {
    -webkit-box-shadow: 0 0 .25em .25em rgba(35, 68, 229, .2);
    box-shadow: 0 0 .25em .25em rgba(35, 68, 229, .2)
}
